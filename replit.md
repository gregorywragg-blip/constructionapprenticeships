...
- **Behavior Check-Up Page**: Created new page at /behavior-check displaying 12 sample behavioral interview questions commonly asked during apprenticeship interviews. Each question includes the skill being assessed, sample great response (green styling), and sample poor response (red styling) to help candidates understand what employers are looking for. The page includes proper dark mode support with accessible color contrast in both themes.
